...
[Collection(nameof(TestLinkedListStack))]
public class TestLinkedListStack
{
    ...
    {
        // Arrange
        Core.Linear.Stacks.Stack<int> stack = new(LinkedListTyped, size);
    ...
    {
        // Arrange
        Core.Linear.Stacks.Stack<object> stack = new(LinkedListTyped, size);
    ...
    {
        // Arrange
        Core.Linear.Stacks.Stack<int> stack = new(LinkedListTyped, 4);
