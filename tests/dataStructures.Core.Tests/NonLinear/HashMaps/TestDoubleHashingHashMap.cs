...
[Collection(nameof(TestDoubleHashingHashMap))]
public class TestDoubleHashingHashMap
{
    [Theory]
    [InlineData(-1)]
    [InlineData(0)]
    ...
    public void Should_Test_HashMap_Construction(float loadFactor)
    {
        ...
        void ConstructHashMap() => hashMap = new(OpenAddressingDoubleHashing, loadFactor);
