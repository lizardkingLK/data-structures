...
[Collection(nameof(TestRobinHoodHashingHashMap))]
public class TestRobinHoodHashingHashMap
{
    [Theory]
    [InlineData(-1)]
    [InlineData(0)]
    ...
    public void Should_Test_HashMap_Construction(float loadFactor)
    {
        ...
        void ConstructHashMap() => hashMap = new(OpenAddressingRobinHoodHashing, loadFactor);
    ...
    [Fact]
    public void Should_Test_HashMap_Get_Method_When_Contains_And_Try_Robin_Hood()
    {
        // Arrange
        HashMap<int, int> hashMap = new(OpenAddressingRobinHoodHashing);
        ...
        // Act
        bool doesContain1 = hashMap.TryGet(1, out int value1);
        bool doesContain2 = hashMap.TryGet(5, out int value2);
        bool doesContain3 = hashMap.TryGet(9, out int value3);
